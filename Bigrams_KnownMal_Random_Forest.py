...
# print(classification_report(y_test, y_pred, target_names=['Benign', 'Known Malware']))
# Generate the classification report
report = classification_report(y_test, y_pred, target_names=['Benign', 'Known Malware'], output_dict=True)
...
# If you want to print the standard report as well
