...
# Combine test data
X_test = test_unknow_malware_api_calls + test_PE_benign_api_calls + test_PE_extension_api_calls
y_test = test_unknow_malware_labels + test_PE_benign_labels + test_PE_extension_labels
times_test = test_unknow_malware_times + test_PE_benign_times + test_PE_extension_times
...
report = classification_report(y_test, y_pred, target_names=['Benign', 'Unknown Malware'], output_dict=True)
